	...
	<table class="Liste" style="width: 600px;" cellspacing="0">
		...
		<tr>
			<td style="text-align: center;">
				<i>
					<img src="pics/gruppe.php?id=<?=$gruppe->ID; ?>&amp;<?=intval(time()); ?>" alt="Bisher wurde kein Bild hochgeladen..." />
				</i>
			</td>
		</tr>
		<tr>
	...
	<table class="Liste" style="width: 600px; margin-top: 30px;" cellspacing="0">
		...
		<tr>
			<td style="text-align: center;">
				...
				<textarea name="beschreibung" cols="60" rows="12"><?=htmlentities(stripslashes($gruppe->Beschreibung), ENT_QUOTES, "UTF-8"); ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="text-align: center;">
...
<input type="hidden" name="a" value="11" />
	<table class="Liste" style="width: 600px; margin-top: 30px;" cellspacing="0">
		...
		<tr>
			<td style="text-align: center;" colspan="2">
				<input type="submit" value="Gruppe l&ouml;schen" onclick="return confirm('Wollen Sie die Gruppe wirklich löschen?');" />
			</td>
		</tr>
	</table>
</form>
