...
-- Die Views
-- 
CREATE VIEW log_bioladen_view AS SELECT 
  m.Name AS Wer,
  l.Wann,
  l.Was,
  l.Wieviel,
...
CREATE VIEW log_bank_view AS SELECT 
  m.Name AS Wer,
  l.Wann,
  l.Wieviel,
...
CREATE VIEW log_gruppenkasse_view AS SELECT 
  m1.Name AS Wer,
  m2.Name AS Wen,
	g.Name AS Gruppe,
  l.Wann,
...
CREATE VIEW log_login_view AS SELECT 
  m.Name AS Wer,
  l.IP,
  l.Wann,
...
CREATE VIEW log_mafia_view AS SELECT 
  m1.Name AS Wer,
  m2.Name AS Wen,
  l.Wann,
  IF(
...
CREATE VIEW log_vertraege_view AS SELECT 
  m1.Name AS Wer,
  m2.Name AS Wen,
  l.Wann,
  l.Was AS Ware,
...
CREATE VIEW log_nachrichten_view AS SELECT 
  m1.Name AS Wer,
  m2.Name AS Wen,
  l.Wann,
	l.Betreff,
