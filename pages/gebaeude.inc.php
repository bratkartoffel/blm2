...
<table id="SeitenUeberschrift">
	<tr>
		...
		<td style="font-size: 16pt; font-weight: bold; text-decoration: underline">Ihre Gebäude
			<a href="./?p=hilfe&amp;mod=1&amp;cat=4"><img src="pics/help.gif" alt="Hilfe" style="border: none;" /></a>
		</td>
	</tr>
</table>
<?php
	...
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				...
				Dauer: &nbsp;<b><?=(date("d", $Plantage->Dauer-3600)-1) . " Tage " . date("H:i:s", $Plantage->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Plantage->Kosten*$Plantage->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Plantage->Dauer*$Plantage->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Plantage->Dauer*$Plantage->DauerFaktor)-3600); ?> min</b><br />
...
<table class="Liste" cellspacing="0">
	...
	<tr>
		...
		<td colspan="2">
			...
			Ausserdem werden neue Gemüsesorten bekannt, je h&ouml;her das Forschungszentrum ist und die Forschungszeit für eine Stufe um <?=BONUS_FAKTOR_FORSCHUNGSZENTRUM*100; ?>% je Stufe gesenkt.
		</td>
	</tr>
</table>
<table class="Liste" cellspacing="0" style="margin-top: -2px;">
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format($Forschungszentrum->Kosten, 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", $Forschungszentrum->Dauer-3600)-1) . " Tage " . date("H:i:s", $Forschungszentrum->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Forschungszentrum->Kosten*$Forschungszentrum->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Forschungszentrum->Dauer*$Forschungszentrum->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Forschungszentrum->Dauer*$Forschungszentrum->DauerFaktor)-3600); ?> min</b><br />
	...
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				...
				Dauer: &nbsp;<b><?=(date("d", $Bioladen->Dauer-3600)-1) . " Tage " . date("H:i:s",$Bioladen->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Bioladen->Kosten*$Bioladen->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Bioladen->Dauer*$Bioladen->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Bioladen->Dauer*$Bioladen->DauerFaktor)-3600); ?> min</b><br />
...
<table class="Liste" cellspacing="0" style="margin-top: -2px;">
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format($Doenerstand->Kosten, 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", $Doenerstand->Dauer-3600)-1) . " Tage " . date("H:i:s", $Doenerstand->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Doenerstand->Kosten*$Doenerstand->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Doenerstand->Dauer*$Doenerstand->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Doenerstand->Dauer*$Doenerstand->DauerFaktor)-3600); ?> min</b><br />
...
<table class="Liste" cellspacing="0">
	...
	<tr>
		...
		<td colspan="2">
			...
			Dabei steigt der Gewinn pro Kilo und Stufe um <?=number_format(WAREN_PREIS_VERKAEUFERSCHULE, 2, ",", ".") . " " . $Currency; ?>!
		</td>
	</tr>
</table>
<table class="Liste" cellspacing="0" style="margin-top: -2px;">
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				...
				Dauer: &nbsp;<b><?=(date("d", $Schule->Dauer-3600)-1) . " Tage " . date("H:i:s", $Schule->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Schule->Kosten*$Schule->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Schule->Dauer*$Schule->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Schule->Dauer*$Schule->DauerFaktor)-3600); ?> min</b><br />
...
<table class="Liste" cellspacing="0">
	...
	<tr>
		...
		<td colspan="2">
			Dieses Gebäude senkt die Ausbauzeiten sämtlicher Gebäude um <?=BONUS_FAKTOR_BAUHOF*100; ?>% pro Stufe. Der Bauhof wird erst beim späten Spielverlauf wichtig.
		</td>
	</tr>
</table>
<table class="Liste" cellspacing="0" style="margin-top: -2px;">
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				...
				Dauer: &nbsp;<b><?=(date("d", $Bauhof->Dauer-3600)-1) . " Tage " . date("H:i:s", $Bauhof->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Bauhof->Kosten*$Bauhof->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Bauhof->Dauer*$Bauhof->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Bauhof->Dauer*$Bauhof->DauerFaktor)-3600); ?> min</b><br />
...
<table class="Liste" cellspacing="0">
	...
	<tr>
		...
		<td colspan="2">
			Dieses Gebäude bietet den einzigen Schutz gegen Angriffe der Mafia. Dabei senkt jede Stufe des Zauns die Erfolgschancen des Gegners um <?=BONUS_FAKTOR_ZAUN;?>%.<br />
	...
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				...
				Dauer: &nbsp;<b><?=(date("d", $Zaun->Dauer-3600)-1) . " Tage " . date("H:i:s", $Zaun->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Zaun->Kosten*$Zaun->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Zaun->Dauer*$Zaun->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Zaun->Dauer*$Zaun->DauerFaktor)-3600); ?> min</b><br />
...
<table class="Liste" cellspacing="0">
	...
	<tr>
		...
		<td colspan="2">
			...
			Je weiter Sie die Pizzeria ausbauen, desto mehr Mafiosi lassen sich in der Stadt nieder und desto h&ouml;her sind Ihre Erfolgschancen. Dabei steigen die Chancen pro Stufe um <?=BONUS_FAKTOR_PIZZERIA;?>%.
		</td>
	</tr>
</table>
<table class="Liste" cellspacing="0" style="margin-top: -2px;">
	<tr>
		...
		<?php
			...
			<p style="padding-top: 10px; margin: 0;">
				...
				Dauer: &nbsp;<b><?=(date("d", $Pizzeria->Dauer-3600)-1) . " Tage " . date("H:i:s", $Pizzeria->Dauer-3600); ?> min</b><br />
			...
			<p style="padding-top: 10px; margin: 0;">
				Kosten: <b><?=number_format(($Pizzeria->Kosten*$Pizzeria->KostenFaktor), 2, ',', '.') . ' ' . $Currency; ?></b><br />
				Dauer: &nbsp;<b><?=(date("d", ($Pizzeria->Dauer*$Pizzeria->DauerFaktor)-3600)-1) . " Tage " . date("H:i:s", ($Pizzeria->Dauer*$Pizzeria->DauerFaktor)-3600); ?> min</b><br />
