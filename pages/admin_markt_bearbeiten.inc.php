...
<table id="SeitenUeberschrift">
	<tr>
		...
		<td style="font-size: 16pt; font-weight: bold; text-decoration: underline">Admin - Marktplatz - Angebot bearbeiten</td>
	</tr>
</table>
...
<?php
				...
				?> 
				</select> zu <input type="text" name="preis"  size="3" value="<?=number_format($angebot->Preis, 2, ",", "."); ?>" /> <?=$Currency; ?> pro kg
