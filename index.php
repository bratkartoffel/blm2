...
?>
	...
	<body onload="MarkActiveLink();">
		<div id="Wrapper">
			<div id="Inhalt">
				<?php
					if($_SERVER["HTTP_HOST"] == "blm2.onlinefangbuch.de") {
						// NICHT ÄNDERN, AUSSER DU WEISST WAS DU TUST!
						// Dieser Werbungscode darf _nur_ auf meinem Server angezeigt werden!
						if(IstAngemeldet() && ShowBanner($ich->LastBannerView)) {		
						// Das Banner wird bei angemeldeten Benutzern nur angezeigt, wenn der letzte View mehr als 1 Stunden her ist
							echo '<div id="Werbung"><!-- Start adshot.de PPV Bannercode --><script type="text/javascript" src="http://www.adshot.de/click_adshot/paidview.php?f=468&amp;id=bratkartoffel"></script><!-- End adshot.de Bannercode --></div>';
						...
						if(!IstAngemeldet()) {
						// Bei nicht angemeldeten Benutzern wird die Werbung immer angezeigt
							echo '<div id="Werbung"><!-- Start adshot.de PPV Bannercode --><script type="text/javascript" src="http://www.adshot.de/click_adshot/paidview.php?f=468&amp;id=bratkartoffel"></script><!-- End adshot.de Bannercode --></div>';
						}
					}
...
?>
					...
					<p>
						...
						<a onclick="window.open(this.href); return false;"  href="http://jigsaw.w3.org/css-validator/validator?uri=<?=urlencode(AJAX_SERVER_PFAD); ?>%2Fstyles%2Fstyle.css&amp;warning=1&amp;profile=css21&amp;usermedium=all">
							<img src="pics/valid-css.png" alt="Valid CSS" style="border: none" />
						</a>
						<a onclick="window.open(this.href); return false;" href="http://www.CynthiaSays.com/org/cynthiatested.htm">
			...
			<div id="Navigation">
				<img src="./pics/logo.png" alt="BLM 2" style="margin: 0; padding: 0; margin-bottom: 7px; margin-left: 30px;" />
				...
				<div class="NaviMitte">
					...
					<?php
						if($ich->Sitter->Gebaeude ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=gebaeude&amp;<?=intval(time()); ?>">Gebäude</a></div>
							<?php
						}
						
						if($ich->Sitter->Produktion ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=plantage&amp;<?=intval(time()); ?>">Plantage</a></div>
							<?php
						}
						
						if($ich->Sitter->Forschung ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=forschungszentrum&amp;<?=intval(time()); ?>">Forschungszentrum</a></div>
							<?php
						}
						
						if($ich->Sitter->Bioladen ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=bioladen&amp;<?=intval(time()); ?>">Bioladen</a></div>
							<?php
						}
					?> 
					...
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=buero&amp;<?=intval(time()); ?>">B&uuml;ro</a></div>
					<?php
						if($ich->Sitter->Bank ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=bank&amp;<?=intval(time()); ?>">Bank</a></div>
					<?php
						}
						
						if($ich->Sitter->Vertraege ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=vertraege_liste&amp;<?=intval(time()); ?>">Vertr&auml;ge (<?=intval(Vertraege()); ?>)</a></div>
							<?php
						}
						
						if($ich->Sitter->Marktplatz ||!$_SESSION['blm_sitter']) {
					?>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=marktplatz_liste&amp;<?=intval(time()); ?>">Marktplatz (<?=intval(AngeboteMarkt()); ?>)</a></div>
					<?php
						}
						
						if($ich->Sitter->Mafia ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=mafia&amp;<?=intval(time()); ?>">Mafia</a></div>
							<?php
						}
					?> 
					...
					<?php
						if($ich->Sitter->Gruppe ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=gruppe&amp;<?=intval(time()); ?>">Gruppe (<?=intval(NeueGruppenNachrichten($ich)); ?>)</a></div>
							<?php
						}
						
						if($ich->Sitter->Nachrichten ||!$_SESSION['blm_sitter']) {
							?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=nachrichten_liste&amp;<?=intval(time()); ?>">Nachrichten (<?=intval(NeueNachrichten()); ?>)</a></div>
							<?php
						}
					?> 
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=notizblock&amp;<?=intval(time()); ?>">Notizblock</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=einstellungen&amp;<?=intval(time()); ?>">Einstellungen</a></div>
					<div class="NaviLink" onclick="return ChefboxZeigen(this.getElementsByTagName('a')[0].href);"><a href="popups/chefbox.php?<?=intval(time()); ?>" onclick="return ChefboxZeigen(this.href);" target="_blank">Chefbox</a></div>
					...
					<?php
						if(istAdmin()) {
						?>
					<div class="NaviLink" onclick="Navigation(this);" style="margin-bottom: 9px;"><a href="./?p=admin&amp;<?=intval(time()); ?>">Admin-Bereich</a></div>
						
						<?php
						}
					?>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=rangliste&amp;o=<?=$ich->RanglisteOffset; ?>&amp;highlight=<?=$_SESSION['blm_user']; ?>&amp;<?=intval(time()); ?>">Rangliste</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=statistik&amp;<?=intval(time()); ?>">Serverstatistik</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=regeln&amp;<?=intval(time()); ?>">Regeln</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=hilfe&amp;<?=intval(time()); ?>">Hilfe</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=changelog&amp;<?=intval(time()); ?>">Changelog</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=impressum&amp;<?=intval(time()); ?>">Impressum</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./actions/logout.php?p=dummy&amp;<?=intval(time()); ?>">Abmelden</a></div>
					<?php
					...
					<div class="NaviLink" style="margin-top: 10px;" onclick="Navigation(this);"><a href="./?p=anmelden">Anmelden</a></div>
					<div class="NaviLink" onclick="Navigation(this);"><a href="./?p=registrieren">Registrieren</a></div>
					<div class="NaviLink" style="margin-top: 10px;" onclick="Navigation(this);"><a href="./?p=regeln">Regeln</a></div>
