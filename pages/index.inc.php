...
<?= getMessageBox(getOrDefault($_GET, 'm', 0)); ?>
    ...
    <p>
        ...
        Bauen und Forschen Sie <?= Config::getInt(Config::SECTION_BASE, 'count_wares'); ?> verschiedene Gemüsesorten und
        feilschen Sie mit Ihren
        Mitspielern um den besten Preis.
    </p>
    <p>
        Bauen Sie Ihre Plantage, Ihr Forschungszentrum oder noch
        weitere <?= (Config::getInt(Config::SECTION_BASE, 'count_buildings') - 2); ?> Gebäude aus.<br/>
