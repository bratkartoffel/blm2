...
<table id="SeitenUeberschrift">
	<tr>
		...
		<td style="font-size: 16pt; font-weight: bold; text-decoration: underline">Das Profil von <?=htmlentities($profil->Name, ENT_QUOTES, "UTF-8"); ?></td>
	</tr>
</table>
...
<b>
	Hier sehen Sie das Profil des Benutzers &quot;<?=htmlentities($profil->Name, ENT_QUOTES, "UTF-8"); ?>&quot;. Der Spieler ist f&uuml;r sein Profil selbst verantwortlich!
</b>
<br />
<br />
...
?></td>
	...
	<tr>
		<td>Punkte:</td>
		<td><?=number_format(GetSpielerPunkte($profil->ID), 0, ",", "."); ?> (Platz: <a href="./?p=rangliste&amp;o=<?=intval(($platz-1)/RANGLISTE_OFFSET); ?>&amp;highlight=<?=$profil->ID; ?>&amp;<?=time(); ?>"><?=$platz; ?></a>)</td>
	</tr>
	<tr>
		<td>Kontakt:</td>
		<td>
