	...
	<table class="Liste" cellspacing="0" style="width: 500px;">
		...
		<tr>
			<td style="text-align: center;">
				<textarea name="notizblock" cols="10" rows="10" style="width: 480px; height: 400px;" maxlength="4096" onkeyup="ZeichenUebrig(this, document.form_notizblock.getElementsByTagName('span')[0]);"><?=htmlentities(stripslashes($ich->Notizblock), ENT_QUOTES, "UTF-8"); ?></textarea>
			</td>
		</tr>
		<tr>
			<td style="text-align: center;">
