...
<table id="SeitenUeberschrift">
	<tr>
		...
		<td style="font-size: 16pt; font-weight: bold; text-decoration: underline">Das Forschungszentrum
			<a href="./?p=hilfe&amp;mod=1&amp;cat=6"><img src="pics/help.gif" alt="Hilfe" style="border: none;" /></a>
		</td>
	</tr>
</table>
<?php
...
<table class="Liste" cellspacing="0" style="margin-bottom: 20px;">
	<tr>
		<th colspan="3"><a id="f<?=$i; ?>"></a><?=WarenName($i); ?>, aktuell Stufe <?=$ich->$temp; ?></th>
	</tr>
	<tr>
		...
		<td>
			...
			<p>
				Dauer: <b><?=(date("d", $forschung_dauer-3600)-1) . " Tage " . date("H:i:s", $forschung_dauer-3600); ?> min</b><br />
				Kosten: <b><?=number_format($forschung_kosten, 2, ',', '.') . " " . $Currency; ?></b><br />
