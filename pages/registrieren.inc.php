...
<b>
	Hier k&ouml;nnen Sie einen neuen Spieler anlegen. Bitte geben Sie hierzu einen Spielernamen ein, welcher noch nicht belegt ist und w&auml;hlen Sie ein Passwort, welches nur Sie wissen sollten.
</b>
<br />
<br />
...
<form action="./actions/registrieren.php" method="post" name="form_login">
	<table class="Liste" style="width: 550px" cellspacing="0">
		...
		<tr>
			...
			<td rowspan="2" id="PasswordOK"><img src="./pics/small/error.png" alt="Passwort&uuml;berpr&uuml;fung" style="margin-right: 10px;" /> <span></span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2" style="text-align: center;">
				<?php
					...
					$captcha->erstelle();
				?>
				<img src="include/captcha_class/pics/<?=basename($captcha->holeBildpfad()); ?>" alt="Sicherheitscode" id="Captcha" />
				<input type="hidden" name="bild" value="<?=basename($captcha->holeBildpfad()); ?>" />
			</td>
		</tr>
		<tr>
			<td colspan="2" style="text-align: center;"><input type="text" name="captcha_code" maxlength="4" size="3" /></td>
		</tr>
		<tr>
			<td colspan="3" style="text-align: center;">
			  <span style="color: red;">
					Mit Ihrer Registrierung akzeptieren Sie die <a href="./?p=regeln">Regeln</a> des Bioladenmanagers.<br />
