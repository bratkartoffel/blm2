...
<form action="./actions/einstellungen.php" method="post">
	...
	<table class="Liste" style="width: 300px;" cellspacing="0" id="EMail">
		...
		<tr>
			<td>EMail:</td>
			<td><input type="text" name="email" value="<?=htmlentities(stripslashes($ich->EMail), ENT_QUOTES, "utf-8"); ?>" style="width: 95%;" /></td>
		</tr>
		<tr>
...
<form action="./actions/einstellungen.php" method="post" name="form_beschreibung">
	...
	<table class="Liste" style="width: 300px; margin-top: 30px;" cellspacing="0" id="Beschreibung">
		...
		<tr>
			<td><textarea maxlength="4096" name="beschreibung" cols="33" rows="10" onkeyup="ZeichenUebrig(this, document.form_beschreibung.getElementsByTagName('span')[0]);"><?=htmlentities(stripslashes($ich->Beschreibung), ENT_QUOTES,"UTF-8");?></textarea></td>
		</tr>
		<tr>
			<td colspan="2" style="text-align: center;">Noch <span>4096</span> Zeichen übrig.<input type="submit" value="Absenden" /></td>
		</tr>
	</table>
</form>
...
<form action="./actions/einstellungen.php" method="post">
	...
	<table class="Liste" style="width: 300px; margin-top: 30px;" cellspacing="0" id="Sitter">
		...
		<tr>
			<td>Passwort:</td>
			<td><input type="text" name="pw_sitter" value="<?=htmlentities(stripslashes($ich->Sitter->Passwort), ENT_QUOTES, "UTF-8"); ?>" size="50" /> <?php
