...
<table id="SeitenUeberschrift">
	<tr>
		...
		<td style="font-size: 16pt; font-weight: bold; text-decoration: underline">Der Marktplatz
			<a href="./?p=hilfe&amp;mod=1&amp;cat=11"><img src="pics/help.gif" alt="Hilfe" style="border: none;" /></a>
		</td>
	</tr>
</table>
<?php
...
<b>
	Hier sehen Sie die aktuellen Angebote auf dem anonymen Marktplatz. Die Preise k&ouml;nnen selbst bestimmt werden und richten sich wahrscheinlich nach dem aktuellen Fortschritt des Spiels.
</b>
<br />
<br />
<form action="./?<?=time(); ?>" method="get" />
	...
	<table class="Liste" style="width: 500px;" cellspacing="0">
		<tr>
			<th>Filter</th>
			<th colspan="3" style="text-align: right;"><a href="./?p=marktplatz_liste&amp;o=0" onclick="AllesAuswaehlen(document.forms[0], ''); return false;" />Alles abwählen</a> | <a href="./?p=marktplatz_liste&amp;o=0&amp;<?=time(); ?>" onclick="AllesAuswaehlen(document.forms[0], 'checked'); return false;" />Alles auswählen</a></th>
		</tr>
		<tr>
			<?php
				$filter=$_GET['w'];
