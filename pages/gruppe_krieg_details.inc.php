...
<table class="Liste" style="width: 450px;">
	...
	<tr>
		<td>Krieg gegen:</td>
		<td><a href="./?p=gruppe&amp;id=<?=$krieg->GegnerID; ?>&amp;<?=time(); ?>"><?=htmlentities(stripslashes($krieg->GegnerName), ENT_QUOTES, "UTF-8"); ?></a></td>
	</tr>
	<tr>
		<td>Kriegsbeginn:</td>
	...
	<tr>
		...
		<td style="text-align: center;"><a href="actions/gruppe.php?a=18&amp;id=<?=$id; ?>" onclick="return confirm('Wollen Sie wirklich den Krieg beenden und kapitulieren?\nAuswirkungen auf Ihre Gruppe:\n\n· Der umkämpfte Betrag (<?=number_format($krieg->Betrag, 0, ",", ".") . " " . $Currency; ?>) geht an den Gegner\n· Die Plantagen Ihrer Mitglieder werden um 2 Stufe gesenkt.\n· Jedes Ihrer Mitglieder verliert 5% seiner Punkte.');">Kapitulation</a></td>
	</tr>
</table>
<?php
	}
