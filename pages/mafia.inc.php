...
<table id="SeitenUeberschrift">
	<tr>
		...
		<td style="font-size: 16pt; font-weight: bold; text-decoration: underline">Die Mafia
			<a href="./?p=hilfe&amp;mod=1&amp;cat=12"><img src="pics/help.gif" alt="Hilfe" style="border: none;" /></a>
		</td>
	</tr>
</table>
<?php
...
?> 
<b>
	Hier finden Sie Jungs die f&uuml;r Sie die Konkurrenz in Bedr&auml;ngnis setzen und die Drecksarbeit f&uuml;r Sie erledigen.
</b>
<br /><br />
<table class="Liste" cellspacing="0" style="width: 650px;">
	...
	<tr>
		<td>Angriff</td>
		<td>Stiehlt dem Gegner zwischen <?=MAFIA_DIEBSTAHL_MIN_RATE; ?> und <?=MAFIA_DIEBSTAHL_MAX_RATE; ?>% seines Bargeldes</td>
