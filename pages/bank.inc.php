...
<b>
	Hier k&ouml;nnen Sie Ihr verdientes Geld anlegen oder auch Kredite aufnehmen, wenns mal knapp wird. Die Zinsen werden jeden Tag neu ausgerechnet. Gebucht werden die Zinsen alle <?php echo (ZINSEN_DAUER/60); ?> Minuten. Die maximale Summe, die Sie anlegen k&ouml;nnen, sind <span style="color: red;"><?php
	...
	<table class="Liste" style="width: 350px;" cellspacing="0">
		...
		<tr>
			...
			<td style="white-space: nowrap;">
				<input type="text" name="betrag" size="9" value="<?php echo number_format($ich->Geld, 2, ",", ""); ?>" onkeyup="changed=true;" /> <?=$Currency; ?>
			</td>
			<td>
				<input type="submit" value="Best&auml;tigen" onclick="document.forms[0].submit(); this.disabled='disabled'; this.value='Bitte warten...'; return false;" />
			</td>
		</tr>
	</table>
</form>
