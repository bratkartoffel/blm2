...
<table id="SeitenUeberschrift">
	<tr>
		...
		<td style="font-size: 16pt; font-weight: bold; text-decoration: underline">Das Changelog
			<a href="./?p=hilfe&amp;mod=1&amp;cat=20"><img src="pics/help.gif" alt="Hilfe" style="border: none;" /></a>
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td>
			...
			while($aenderung=mysql_fetch_object($sql_ergebnis3)) {
				$nr++;
				?> 
				<li><u>#<?=$aenderung->ID; ?>:</u> <?=htmlentities(stripslashes($aenderung->Aenderung),ENT_QUOTES,"UTF-8"); ?></li><?php
			}
			?> 
			</ul>
		</td>
