...
;";
    ...
    if (mysql_affected_rows() > 0) {
        ?>
        <h2>
            Das Christkind hat in Ihrem Bioladen vorbeigeschaut und ein Geschenk hinterlassen. Schön versteckt hinter
            einem Haufen aus frisch geernteten Kartoffeln haben Sie das Geschenk gefunden. Wie ein Kind an Heiligabend
            reißen Sie die Verpackung herunter und öffnen das Paket.<br/>
            <br/>
            Darin finden Sie <?= intval($_GET['menge']); ?>kg <?= WarenName(intval($_GET['ware'])); ?>. Voller Stolz
            nehmen Sie die Waren aus dem Paket und verstauen sie im Lager.
        </h2>
        <?php
    } else {
        ?>
    ...
    <br/>
    Zunächst einmal habe ich die Mafia deaktiviert. In der Weihnachtszeit herrscht Frieden, und die Mafiabosse wollen da auch mal in Ruhe mit Ihren Familien die Feiertage verbringen.
    <br/>
    <br/>
