...
?>
		<div style="font-weight: bold; font-size: 12pt;">
			...
			<form action="" method="get">
				...
				<input type="text" name="find_spieler" value="<?=htmlentities(stripslashes($_GET['find_spieler'])); ?>" size="24" /> <span style="font-size: 75%; font-weight: normal;"><i>(Das Zeichen <span style="font-size: 160%">*</span> passt auf ein beliebiges Zeichen)</i></span><br /><br />
				<input type="submit" value="Suchen" />
				<input type="reset" value="Reset" onclick="document.forms[0].find_spieler.value='*'; document.forms[0].submit();" />
			</form>
		</div><br />
<?php
	}
...
<table class="Liste" style="width: 600px;">
	...
	<tr>
		<th style="width: 1px; padding: 2px 8px 2px 8px; border-bottom: solid 1px #666666; white-space: nowrap;">Der Spieler des Tages:</th>
		<td><?php
			$sql_abfrage="SELECT
											ID,
											Name
